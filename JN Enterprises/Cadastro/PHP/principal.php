...
<html lang="eng">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
      integrity="sh-a384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH"
  ...
  <body>
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li>
          <button class="login-button" href="/Html/register.html">
            Registrar-se
          </button>
        </li>
    ...
    <div class="card-position">
      <div class="card">
        <div class="card2">
          ...
          <div class="preco">Preço: R$99,9</div>
